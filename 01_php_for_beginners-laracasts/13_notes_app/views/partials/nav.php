            ...
            <div class="flex items-center">
                ...
                <div class="hidden md:block">
                    <div class="ml-10 flex items-baseline space-x-4">
                        ...
                        <a href="/"
                            class="<?= isUrl("/") ? "bg-gray-900 text-white" : "text-gray-300 hover:bg-gray-700 hover:text-white" ?> rounded-md px-3 py-2 text-sm font-medium"
                    ...
                    <?php else: ?>
                        <div class="space-x-3">
                            <a href="/auth/register"
                                class="<?= isUrl("/auth/register") ? "bg-gray-900 text-white" : "text-gray-300 hover:bg-gray-700 hover:text-white" ?> rounded-md px-3 py-2 text-sm font-medium">Register</a>
                            <a href="/auth/login"
                                class="<?= isUrl("/auth/login") ? "bg-gray-900 text-white" : "text-gray-300 hover:bg-gray-700 hover:text-white" ?> rounded-md px-3 py-2 text-sm font-medium">Login</a>
                        </div>
                    <?php endif ?>
